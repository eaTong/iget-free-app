                ...
                <IonContent>
                    <IonList>
                        <IonItemGroup>
                            ...
                            <IonRadioGroup value={mark.status} onIonChange={(event: any) => this.onChangeMark(event.target.value, 'status')}>
                            ...
                            {mark.status === 3 && (
                                <IonItem>
                                    ...
                                    <IonDatetime displayFormat="YYYY-MM-DD" value={mark.finishTime} onIonChange={(event: any) => this.onChangeMark(event.target.value, 'finishTime')}></IonDatetime>
                                </IonItem>
                            )}
                        ...
                        <IonItemGroup>
                            ...
                            <IonRadioGroup value={mark.listenedStatus || 0} onIonChange={(event: any) => this.onChangeMark(event.target.value, 'listenedStatus')}>
                            ...
                            {mark.listenedStatus === 1 && (
                                <IonItem>
                                    ...
                                    <IonDatetime displayFormat="YYYY-MM-DD" value={mark.finishListeningTime} onIonChange={(event: any) => this.onChangeMark(event.target.value, 'finishListeningTime')}></IonDatetime>
                                </IonItem>
                            )}
                        </IonItemGroup>
                    </IonList>
